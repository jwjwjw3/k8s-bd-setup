...
# set ipv4 rules to enable correct K8s traffic routing
# ip rule del from 10.53.20.16
# ip rule del from 10.53.20.17
# ip rule del from 10.53.20.18
# ip rule del from 10.53.20.19
# ip -4 rule add from all to 192.168.0.0/16 lookup default
# ip -4 rule add from all to 192.168.0.0/16 lookup main